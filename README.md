...
### 🔌 心跳端点（Heartbeat Endpoint）

**仅在 SSE 和 Streamable HTTP 模式下可用**

心跳端点提供服务器健康检查功能，用于客户端检测连接状态：
...
📖 **详细文档**: [specs/001-sse-heartbeat-route/quickstart.md](specs/001-sse-heartbeat-route/quickstart.md)
